        ...
        <div class="hero-content">
            ...
            <div class="hero-left-column">
                ...
                <div class="hero-text" id="slide-2" style="display: none;">
                    ...
                    <p>Chúng tôi tin rằng thế hệ trẻ cần hiểu rõ về nguồn cội để vững bước tiến về tương lai. Thông qua
                        các hoạt động thực tế, sinh viên được trải nghiệm và tiếp nối giá trị văn hóa quý báu của dân
                        tộc.</p>
                </div>
                <div class="hero-text" id="slide-3" style="display: none;">
                    <h2>ĐỒNG HÀNH CÙNG LỊCH SỬ</h2>
                    <p>Tham gia cùng chúng tôi trong hành trình khám phá các di tích lịch sử, tìm hiểu về những anh hùng
                        dân tộc và gắn kết cộng đồng sinh viên qua các hoạt động ý nghĩa.</p>
                </div>
    ...
    <div class="bit-container" id="bit-container">
        <div class="avatar-section">
            <?php if (!empty($slidesData)): ?>
                <img src="<?= htmlspecialchars($slidesData[0]['avatar']) ?>"
                    alt="<?= htmlspecialchars($slidesData[0]['name']) ?>" class="avatar">
            <?php else: ?>
        ...
        <div class="content-section">
            ...
            <div class="slides" id="slides-container">
                ...
                <?php else: ?>
                    <div class="slide active">
                        <div class="slide-content">Tham gia các campaign về cội nguồn lịch sử giúp ta hiểu sâu hơn về văn
                            hóa, truyền thống và tinh thần dân tộc. Những chuyến đi ấy không chỉ khơi dậy lòng tự hào mà còn
                            truyền cảm hứng để thế hệ trẻ gìn giữ và phát huy giá trị lịch sử.</div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="buttons">
                <a href="/BANKYTHUAT-WEB/ModelViews/Ve_chien_dich/ve_chien_dich.html" class="button">NỘI DUNG CHƯƠNG
                    TRÌNH</a>

...
<body>
    <?php
    include 'Hanh_trinh_trai_nghiem.php';
    $sv_query = mysqli_query($conn, "SELECT * FROM sinhvien")
        ?>
    <div class="bit-container">
        <div class="avatar-section">
            <?php
            while ($row = mysqli_fetch_array($sv_query)){
            ?>
            <!-- Avatar ban đầu được hiển thị từ slide đầu tiên -->
            <img src="../assets/img/sv/<?php echo $row["sv_img"];}?>" alt="Student avatar" class="avatar">
        </div>
    ...
    <script src="./Hanh_trinh_trai_nghiem.js" defer></script>
</body>
